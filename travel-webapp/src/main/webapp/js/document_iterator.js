...
SkypeToolbars.DocumentCursor = function(rootNode, toStart)
{
    ...
    m_currentNode;     The root node or node calculated in SetAfter. If not @c null, then it should be returned from the MoveNext wo moving TreeWalker.
 ...
 Implementation of the IDocumentCursorCloneCursor.
...
SkypeToolbars.DocumentCursor.prototype.GetBeginOffset = function()
{
 ...
 Implementation of the IDocumentCursorSetAfter.
SkypeToolbars.DocumentCursor.prototype.SetAfter = function(node)
{
  ...
  @return Object with three fields
          ...
          nodeCompare             Compare nodes wo offsets. Negative if @a obj is less than this object, 0 if they are equal, or positive if it is greater. 
...
{
     result
    var result = {resultcodeSkypeToolbars.FAIL, nodeCompare0, nodeWithOffsetsCompare0};
...
{
    var result = {resultCodeSkypeToolbars.FAIL, nodenull, tagWasClosedfalse};
...
SkypeToolbars.DocumentIterator.prototype.Fire = function(cursor, node, tagWasClosed)
{
    ...
    case node.COMMENT_NODE
        ...
        break;
    case node.TEXT_NODE
        var offsets = {beginOffset0, endOffsetSkypeToolbars.npos};
...
SkypeToolbars.DocumentIterator.prototype.Iterate = function()
{
    ...
    if ((node = this.m_fromCursor.root) && node.nodeType == node.TEXT_NODE)
    {
        ...
        while (this.m_listener.CanContinue())
        {
            ...
            var offsets = {beginOffsetbeginOffset, endOffsetendOffset};
